...
- `/users`: Returns 5 randomly selected usernames from a predefined list. Each user contains an id, username and email.

## Frontend
- `/`: Home page, displays the data from each API route with a roload button.
